...
This handbook leans heavily on the following works:

 - [Candice Morey's lab handbook][1]
 - [Jonathan Peelle's lab manual][2]
 - [Joshua Hartshorne's Language Learning Lab Manual][3]
...
# References
  ...
  [1]: https://github.com/CCMorey/labHandbook
  [2]: http://jpeelle.net/peellelab_manual.pdf
  [3]: http://l3atbc.org/L3Manual.pdf
