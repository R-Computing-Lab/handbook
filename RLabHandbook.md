...
4.	Once connected through VPN, you need to open the Microsoft Remote Desktop software and key in the following IP address



5.	(also, you should enter your ID and password)
	For example, if your email address is “ Gravity21@wfu.edu” and your password is “11111111”, you should key in “Gravity21” and “11111111


<!--chapter:end:0003_remoteaccess.Rmd-->
...
<!--chapter:end:0102_communication.Rmd-->
...
```r
    ...
    expand.grid(height = seq(60, 80, 5), weight = seq(100, 300, 50), type = c("Cat","Dog"))
#>    height weight type
#> 1      60    100  Cat
#> 2      65    100  Cat
#> 3      70    100  Cat
...
Returns the most recent cached version of a web page 
...
(Source: [Wikipedia](https://en.wikipedia.org/wiki/Bookmarklet#:~:text=A%20bookmarklet%20is%20a%20bookmark,Bookmarklets%20are%20usually%20JavaScript%20programs))
...
If you have multiple google accounts, you can add "?authuser=1" to switch to your 2nd account.
...
<!--chapter:end:0400_usefulthings.Rmd-->
