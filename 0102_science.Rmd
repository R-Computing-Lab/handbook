...
```{r, echo=FALSE}
try(include_tweet("https://twitter.com/meriahdejoseph/status/1461484970074152960"))
...
```{r, echo=FALSE}
try(include_tweet("https://twitter.com/DrasmaJabeen1/status/1459448488048140294"))
...
One way to operationalize authorship is the [Contributor Roles Taxonomy (CRediT)](https://credit.niso.org/). This a helpful framework can be used to determine who should be listed as authors of a research paper. CRediT includes 14 different roles that describe the specific contributions made by each individual involved in the research. Although not exhaustive, these roles are a great way to make sure everyone who contributed to the project is recognized appropriately.
...
Practically speaking, this ordering means that I (Mason) will probably be last author, and any project that you, dear reader, lead are first author.
